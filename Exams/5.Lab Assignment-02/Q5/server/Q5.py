...
while True:
    ...
    if len(source_obj_list) > 0:
        ...
        # print('source_obj1 :', source_obj1)
        source_obj1_name_list = source_obj1.split('\\')[-1].split('.')
        # print('source_obj1_name_list[0] :', source_obj1_name_list[0])
        # print('source_obj1_name_list[1] :', source_obj1_name_list[1])
        # print(source_obj1_name_list[0] + '.' + source_obj1_name_list[1])
