...
myStudent = Student('Ananta', 'MBA', 'UK School', 'Cricket')

print(myStudent.name)
print(myStudent.grade_name)
print(myStudent.school_name)
myStudent.add_player('Borsha')
myStudent.add_player('Ananta')
print(myStudent.team)